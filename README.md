...
[![Build and Test](https://github.com/SSWConsulting/Solar.Heliac/actions/workflows/build-and-test.yml/badge.svg?branch=main)](https://github.com/SSWConsulting/Solar.Heliac/actions/workflows/build-and-test.yml)
[![Code Scanning](https://github.com/SSWConsulting/Solar.Heliac/actions/workflows/codeql.yml/badge.svg)](https://github.com/SSWConsulting/Solar.Heliac/actions/workflows/codeql.yml)
[![Package](https://github.com/SSWConsulting/Solar.Heliac/actions/workflows/package.yml/badge.svg)](https://github.com/SSWConsulting/Solar.Heliac/actions/workflows/package.yml)
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/dwyl/esta/issues)
[![ADRs](https://sswconsulting.github.io/Solar.Heliac/badge.svg)](https://sswconsulting.github.io/Solar.Heliac/)

</div>

<div align="center">

![Solar.Heliac Repo Analytics](https://repobeats.axiom.co/api/embed/3abf953e88642f725e44f5b300f6eddaf8fd9bee.svg "Solar.Heliac Repo analytics")
...
```bash
dotnet new install Solar.Heliac.Template
```
